...
<head>
	...
	<title>List Customers | SKYPOS</title>
							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
                                        ...
                                        <a class=" ml-auto" href="add-customers.php">
										...
										<table id="add-row" class="display table table-striped table-hover" >
											...
											<tbody>
												...
												echo "<tr>";
													...
													echo "<td >".$dataRow['cus_phone']."</td>";
													echo "<td >".$dataRow['cus_email']."</td>";
													echo "<td >".$dataRow['cus_custom_feild']."</td>";
													echo "<td>
														<div class=\"form-button-action\">
															<a href='edit-customers.php?id=$dataRow[cus_id]'>
															...
															<a onClick=\"javascript: return confirm('Please confirm deletion');\" href='delete-customerpro.php?id=$dataRow[cus_id]'>
