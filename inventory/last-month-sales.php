                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="example" class="display table table-striped table-hover">
                                            ...
                                            $sqlT = "SELECT * FROM pos_tbl,user_tbl WHERE MONTH(checkRegDate) = MONTH(CURRENT_DATE())-1 AND YEAR(checkRegDate) = YEAR(CURRENT_DATE()) AND bill_void=0 AND user_tbl.user_id = pos_tbl.added_user AND user_tbl.user_loc = '$userLocationId'";
