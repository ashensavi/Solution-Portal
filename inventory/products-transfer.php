...
<body>
    ...
    <div class="wrapper sidebar_minimize">
            ...
            <div class="content">
                <div class="page-inner">
                    <div class="page-header">
                        <h4 class="page-title">PRODUCTS TRANSFER</h4>
                                        ...
                                        <div class="col-md-12">
                                            <div class="input-group">
                                                <select class="form-control js-select2" id="customertxt">
                                                    ...
                                                    <?php
                                                    $sql = mysqli_query($connection,"SELECT * FROM location_tbl where loc_id = 1 or loc_id = 3 or loc_id = 4 or loc_id = 5 or  loc_id = 6");
                            ...
                            <div class="card card-post card-round"
                                ...
                                <div class="card-body">
                                    <div class="row" id="proList">
                                        <?php
                                        $sql = mysqli_query($connection,"SELECT * FROM products_tbl,stock_tbl,batch_tbl WHERE stock_tbl.pro_id = products_tbl.pro_id AND batch_tbl.batch_id = stock_tbl.batch_id AND batch_tbl.batch_location = 2");
                                        $row = mysqli_num_rows($sql);
                                        while ($row = mysqli_fetch_array($sql)){
                                            $id = $row['stock_id'];
                                            ...
                                            <p style='text-align:center; color:white; margin-top:0px; margin-bottom:0px;'>cost Rs. ".number_format($row['cost'],2)."</p>
                                            <p style='text-align:center; color:white; margin-top:0px; margin-bottom:0px;'>sell Rs. ".number_format($row['price'],2)."</p>
                                            </div>
                                            </div>";
                                        }
                                        ?>
            ...
            for (var i = 0; i < tableData.length; i++) {
                if (tableData[i] !== undefined) {
                    localObj.push({
                        ...
                        costprice:tableData[i].costprice,
            ...
            for (var i = 0; i < tableData.length; i++) {
                if (tableData[i].id === id) {
                    if (tableData[i].qty >= parseInt(editQty)) {
                        ...
                        tableData[i].costprice = parseInt(editcostprice);
                        tableData[i].price = parseInt(editprice);
        ...
        function save() {
            loader.style.display = "block";
            var proObj = [];
            var locId = document.getElementById("customertxt").value;
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (res.status == 'success') {
                        ...
                        // window.location.replace("products-transfer.php?id="+res.sendId);
        ...
        function addRow() {
            ...
            for (var i = 0; i < tableData.length; i++) {
                if (tableData[i] !== undefined) {
                    ...
                    var tr_str = "<tr style='border-bottom:1pt; solid #D9EDF7;'>" +
                        "<td style='text-align:center'>" + x + "</td>" +
                        "<td style='text-align:center'><button class='btn btn-primary btn-xs' onclick='editProduct(" +
                        tableData[i].id + ")'>" + tableData[i].proName +
                        "(" + tableData[i].code + ")" + "</button></td>" +"<td style='text-align:center'>" + 
                        tableData[i].costprice + ".00</td>"+ "<td style='text-align:center'>" + tableData[i].price + ".00</td>" +
                        "<td style='text-align:center'> " + tableData[i].totQty + "</td>" +
                        "<td style='text-align:center'>" + tableData[i].price *
                        tableData[i].totQty + ".00</td>" +
                        "<td style='text-align:center'>" + "<button onclick='removeRow(" + tableData[i].id + ")' type='button'" +
                        "data-toggle='tooltip' title=''" + "class='btn btn-link btn-danger'" +
                        "data-original-title='Remove'>" + "<i class='fa fa-trash'></i>" + "</button></td>" +
                        "</tr>";
            ...
            for (var i = 0; i < tableData.length; i++) {
                if (tableData[i] !== undefined) {
                    if (tableData[i].id == productId) {
                        ...
                        document.getElementById("editcostprice").value = tableData[i].costprice;
                        document.getElementById("editprice").value = tableData[i].price;
            ...
            for (var i = 0; i < tableData.length; i++) {
                if (tableData[i] !== undefined) {
                    if (tableData[i].id == proEditId) {
                        ...
                        tableData[i].costprice = document.getElementById("editcostprice").value;
                        tableData[i].price = document.getElementById("editprice").value;
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="editcostprice" >
                                    <span style="font-size:12px; color:red;" id="editcostpriceSpan"></span>
                                    <label for="">Sell Price</label>
                                    <input type="text" class="form-control" id="editprice" >
                                    <span style="font-size:12px; color:red;" id="editpriceSpan"></span>
                                </div>
                            </div>
                            <div class="col-sm-12">
