...
//                                        print_r($_SESSION);
                                            ...
                                            <div class="col-sm-6">
                                                <div style="margin-top:3px">
                                                    ...
                                                    <textarea type="text" readonly class="form-control" id="location"
                                                              ...
                                                              placeholder=""
                                                              onkeyup="getProduct()"> <?php echo $loc['loc_name'] ?> </textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <br>
    ...
    <script type="text/javascript">
        ...
        function save() {
            ...
            $.ajax({
                url: "ajax/add-purchase-order2.php?user_id=<?php echo $_SESSION['user_id']?>",
                type: "POST",
                data: {
                    data: obj
                },
                        ...
                        var SweetAlert2Demo = function () {
                            var initDemos = function () {
                                swal({
                                    ...
                                    if (Delete) {
                                        window.location.href = "print-po.php?id=" + res.id;
                                    } else {
                                        window.location.href = "print-po.php?id=" + res.id;
                                    }
                                });
            ...
            for (var i = 0; i < tableData.length; i++) {
                if (tableData[i] !== undefined) {
                    ...
                    var tr_str = "<tr style='border-bottom:1pt; solid #D9EDF7;'>" +
                        ...
                        "<td style='text-align:center'>" + tableData[i].cost + "</td>" +
                        "<td style='text-align:center'>" + tableData[i].price + "</td>" +
            ...
            for (var i = 0; i < additionalObj.length; i++) {
                if (additionalObj[i] !== undefined) {
                    ...
                    var tr_str = "<tr style='border-bottom:1pt; solid #D9EDF7;'>" +
                        ...
                        "</button></td>" +
                        "<td style='text-align:center'>" + additionalObj[i].price + "</td>" +
