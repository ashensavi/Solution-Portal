...
<head>
	...
	<title>Purches Order Report | SKYPOS</title>
			...
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">PURCHES ORDER REPORT</h4>
										...
										<div class="col-md-4">
											<div class="form-group">
												...
												<select class="form-control" id="" name="txtcat_id">
													...
													while ($row = mysqli_fetch_array($sql)){                  	echo "<option value='". $row['pro_id'] ."'>" .$row		['pro_name'] ."</option>" ;
													}
													?>
												</select>
											</div>
								...
								<div class="card-body">
									<div class="table-responsive">
										<table id="example" class="display table table-striped table-hover" >
											...
											$sql="SELECT * FROM products_tbl,brand_tbl,category_tbl,subcategory_tbl WHERE brand_tbl.brand_id = products_tbl.brand_id AND category_tbl.cate_id = products_tbl.cat_id AND subcategory_tbl.subcate_id = products_tbl.subcat_id";
