...
<div class="wrapper sidebar_minimize">
        ...
        <div class="content">
            <div class="page-inner">
                <div class="page-header">
                    <h4 class="page-title">DAMAGE PRODUCTS</h4>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select  onchange="loadItems()" class="form-control j-select2" id="dLocation">
    ...
    <script type="text/javascript">
        ...
        function loadItems(){
            ...
            xmlhttp.open("GET", "ajax/get-all-product-filter.php?loc=" + Location, true);
            xmlhttp.send();
        }
        //getAllProductPos();
    </script>
    ...
    <script type="text/javascript">
        ...
        function getHoldValue(id) {
            ...
            document.getElementById("dLocation").value = valueObj.dLocation;
        ...
        function addRow() {
            ...
            for (var i = 0; i < tableData.length; i++) {
                if (tableData[i] !== undefined) {
                    ...
                    var tr_str = "<tr style='border-bottom:1pt; solid #D9EDF7;'>" +
                        "<td style='text-align:center'>" + x + "</td>" +
                        "<td style='text-align:center'><button class='btn btn-primary btn-xs' onclick='editProduct(" + tableData[i].id + ")'>" + tableData[i].proName +
                        "(" + tableData[i].code + ")" + "</button></td>" + "<td style='text-align:center'>" + tableData[i].price * tableData[i].totQty + ".00</td>" +
