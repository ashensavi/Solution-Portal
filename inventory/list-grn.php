                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <a class=" ml-auto" href="good-receive-note.php">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="add-row" class="display table table-striped table-hover">
											...
											$sql=" SELECT * FROM grn_tbl,supplier_tbl,location_tbl,grndetail_tbl,products_tbl,user_tbl WHERE supplier_tbl.supplier_id = grn_tbl.grn_suppid AND location_tbl.loc_id = grn_tbl.grn_locid AND grndetail_tbl.grn_num = grn_tbl.grn_id AND products_tbl.pro_id = grndetail_tbl.grnPro_id AND user_tbl.user_id = grn_tbl.added_user ";
