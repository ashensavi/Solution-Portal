                                            ...
                                            <div class="col-sm">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" id="txt_location_idd" onchange="getByLocation(this.value)">
                                                        ...
                                                        <!-- <select class="form-control"
                                                                id="txt_location_id" onchange="save()">
                                                            <option disabled selected hidden>Select One</option>
                                                            <?php
                                                            // $sql = mysqli_query($connection, "SELECT * FROM location_tbl");
                                                            // $row = mysqli_num_rows($sql);
                            ...
                            <div class="table-responsive">
                                <table id="example" class="display table table-striped table-hover">
                                    ...
                                    if (!empty($_GET['loc'])) {
                                        ...
                                        $sql = "SELECT * FROM stock_tbl,products_tbl,location_tbl,batch_tbl WHERE products_tbl.pro_id = stock_tbl.pro_id AND location_tbl.loc_id = stock_tbl.stock_location AND batch_tbl.batch_id = stock_tbl.batch_id AND batch_tbl.batch_location = '$location_id'";
                                        ...
                                        while ($dataRow = mysqli_fetch_assoc($result)) {
                                            // if ($location_name == $dataRow['loc_name']) {
                                                echo "<tr>";
                                                echo "<td hidden>".$dataRow['stock_id']."</td>";
...
<script>
    function save() {
        // var ids = document.getElementById("txt_product_id").value;
        var id = document.getElementById("txt_location_id").value;
        window.location.href = "stock-report.php?loc=" + id ;
    ...
    // Start - Modification By Tharindu
    function getByLocation(x) {
        console.log(x);
        window.location.href = "stock-report.php?loc=" + x ;
    };
    // End - Modification By Tharindu
