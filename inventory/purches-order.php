            ...
            <div class="content">
                <div class="page-inner">
                    <div class="page-header">
                        <h4 class="page-title">LIST PURCHASE ORDER</h4>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <a class=" ml-auto" href="add-purchase-order.php">
                                    ...
                                    <div class="table-responsive">
                                        <table id="dataTable" class="display table table-striped table-hover">
                                            ...
                                            while($dataRow=mysqli_fetch_assoc($result)){
                                                ...
                                                echo "<td >".$dataRow['po_id']."</td>";
                                                echo "<td >".$dataRow2['supplier_name']."</td>";
                                                echo "<td >".$dataRow['location']."</td>";
                                                echo "<td >".$dataRow['date']."</td>";

                                                echo "<td>
														<div class=\"form-button-action\">
															<a href='edit_PO.php?id=$dataRow[po_id]'>
															...
															<a onClick=\"javascript: return confirm('Please confirm deletion');\" href='delete-po.php?id=$dataRow[po_id]'>
                    ...
                    var SweetAlert2Demo = function() {
                            var initDemos = function() {
                                swal({
                                    ...
                                    if (Delete) {
                                        window.location.href = "print-po.php?id=" + res.poId;
                                    } else {
                                        window.location.href = "print-po.php?id=" + res.poId;
                                    }
                                });
