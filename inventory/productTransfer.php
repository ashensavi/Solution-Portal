                        ...
                        <div class="col-12">
                            ...
                            <div class="">
                                <table style="width:100%;" class="table-head mt-3" id="proTable">
                                    ...
                                    $exchangePrice=0;
                                    $x = 1;
                                    $sql2="SELECT * FROM `main_transfer_tbl` INNER JOIN stock_transfer_tbl on main_transfer_tbl.main_tra_id=stock_transfer_tbl.main_trans_id inner join products_tbl on products_tbl.pro_id=stock_transfer_tbl.trans_stock_id where main_transfer_tbl.main_tra_id=$id";
                                    ...
                                    while($dataRow=mysqli_fetch_assoc($result)){
                                        ...
                                        echo "<td style='text-align:center'>".$dataRow['transfer_qty']."</td>";
                                        echo "</tr>";
                                        $x++;
