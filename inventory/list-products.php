                                    ...
                                    <div class="table-responsive">
                                        <table id="example" class="display table table-striped table-hover">
											...
											while($dataRow=mysqli_fetch_assoc($result)){
                                                ...
                                                // get brand name
                                                $sql1 = mysqli_query($connection, "SELECT * FROM brand_tbl WHERE brand_id = '$dataRow[brand_id]'");
                                                $res1 = mysqli_fetch_array($sql1);

                                                // get category name
                                                $sql2 = mysqli_query($connection, "SELECT * FROM category_tbl WHERE cate_id = '$dataRow[cat_id]'");
                                                $res2 = mysqli_fetch_array($sql2);

                                                // get subcategory name
                                                $sql3 = mysqli_query($connection, "SELECT * FROM subcategory_tbl WHERE subcate_id = '$dataRow[subcat_id]'");
                                                $res3 = mysqli_fetch_array($sql3);

                                                // get supplier name
                                                $sql4 = mysqli_query($connection, "SELECT * FROM supplier_tbl WHERE supplier_id = '$dataRow[supplier_id]'");
                                            ...
                                            echo "<td >".$dataRow['pro_id']."</td>";
                                                ...
                                                echo "<td >".$res2['cat_name']."</td>";
												echo "<td >".$res3['subcate_name']."</td>";    
