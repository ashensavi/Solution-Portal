...
$result = mysqli_query($connection, "SELECT * FROM pos_tbl,user_tbl WHERE MONTH(checkRegDate) = MONTH(CURRENT_DATE()) AND YEAR(checkRegDate) = YEAR(CURRENT_DATE()) AND user_tbl.user_id = pos_tbl.added_user AND user_tbl.user_loc ='$location'");
