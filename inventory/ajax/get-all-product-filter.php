...
<?php
$sql = mysqli_query($connection,"SELECT * FROM products_tbl,stock_tbl,batch_tbl,location_tbl WHERE stock_tbl.pro_id = products_tbl.pro_id AND batch_tbl.batch_id = stock_tbl.batch_id AND batch_tbl.batch_location = location_tbl.loc_id AND location_tbl.loc_id = '$loc'");
