...
<body  style="background-color: white;">
    ...
    $sql = mysqli_query($connection, "select *from po_tbl inner join po_details_tbl on po_tbl.po_id=po_details_tbl.po_id inner join supplier_tbl on po_tbl.supplier_id=supplier_tbl.supplier_id where po_tbl.po_id=$id");
    ...
    <main style="background-color: white;">
        <div id="details" class="clearfix">
            ...
            <div id="invoice">
                ...
                <div class="date">PO Number : <?php echo $id ?></div>
        ...
        <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tbody>
                ...
                <?php
                    $sql="select *from po_tbl right join po_details_tbl on po_tbl.po_id=po_details_tbl.po_id where po_tbl.po_id=$id";
                ...
                <tr>
                    ...
                    <td class="unit"> <?php echo $dataRow['pro_qty']; ?> </td>
                    <td class="qty"><?php echo $dataRow['cost_prise']; ?></td>
<!--                    <td class="unitPrice">--><?php //echo number_format($dataRow['pro_price'],2); ?><!-- </td>-->
