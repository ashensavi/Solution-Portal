...
<body>
								...
								<div class="card">
									<div class="card-body">
										<div class="row">
											<div class="col-md-12">
                                                <div class="">
													<input type="hidden" id="txt_id" value="<?php echo $user_id; ?>">
												</div>
                                                <!-- <div class="">
									...
									<div class="card-action">
										<button id="editbtn" type="submit" class="btn btn-primary" onClick="editUser()">
    ...
    */
    function editUser() {
        ...
        var user_id = document.getElementById("txt_id").value;
	...
	if (<?php echo $res['pos_pos']; ?> == 1) {
		document.getElementById("pos_pos").checked = true;
	}
    if (<?php echo $res['pos_customer']; ?> == 1) {
		document.getElementById("pos_customer").checked = true;
	}
    if (<?php echo $res['pos_bill_sett']; ?> == 1) {
		document.getElementById("pos_bill_sett").checked = true;
	}
    if (<?php echo $res['pos_day_sales']; ?> == 1) {
		document.getElementById("pos_day_sales").checked = true;
	}
    if (<?php echo $res['pos_curr_month_sales']; ?> == 1) {
		document.getElementById("pos_curr_month_sales").checked = true;
	}
    if (<?php echo $res['pos_last_month_sale']; ?> == 1) {
		document.getElementById("pos_last_month_sale").checked = true;
	}
    if (<?php echo $res['pos_dispose_pro']; ?> == 1) {
		document.getElementById("pos_dispose_pro").checked = true;
	}
    if (<?php echo $res['pos_damage_stock']; ?> == 1) {
		document.getElementById("pos_damage_stock").checked = true;
	}
    if (<?php echo $res['pos_reorder_stock']; ?> == 1) {
		document.getElementById("pos_reorder_stock").checked = true;
	}
    if (<?php echo $res['pos_verify_pro_transfer']; ?> == 1) {
		document.getElementById("pos_verify_pro_transfer").checked = true;
	}
    if (<?php echo $res['pos_pro_exchange']; ?> == 1) {
		document.getElementById("pos_pro_exchange").checked = true;
	}
    if (<?php echo $res['pos_stock_rep']; ?> == 1) {
		document.getElementById("pos_stock_rep").checked = true;
	}
    if (<?php echo $res['pos_reo_pro_rep']; ?> == 1) {
		document.getElementById("pos_reo_pro_rep").checked = true;
	}
    if (<?php echo $res['pos_pro_rep']; ?> == 1) {
		document.getElementById("pos_pro_rep").checked = true;
	}
    if (<?php echo $res['pos_sales_rep']; ?> == 1) {
		document.getElementById("pos_sales_rep").checked = true;
	}
    if (<?php echo $res['pos_damage_pro_rep']; ?> == 1) {
		document.getElementById("pos_damage_pro_rep").checked = true;
	}
    if (<?php echo $res['pos_exp_pro_rep']; ?> == 1) {
		document.getElementById("pos_exp_pro_rep").checked = true;
	}
    if (<?php echo $res['pos_disposal_rep']; ?> == 1) {
		document.getElementById("pos_disposal_rep").checked = true;
	}
    if (<?php echo $res['pos_not_moving_item_rep']; ?> == 1) {
		document.getElementById("pos_not_moving_item_rep").checked = true;
	}
    if (<?php echo $res['pos_cashier_reg_rep']; ?> == 1) {
		document.getElementById("pos_cashier_reg_rep").checked = true;
	}
</script>
</body>
</html>