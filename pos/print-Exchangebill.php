...
$sql4 = mysqli_query($connection, "SELECT * FROM pos_tbl WHERE pos_id = '$oldId'");
$res4 = mysqli_fetch_array($sql4);

$oldAmount = $res4['amount'];
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div style="margin-top:0px; margin-bottom:0px;" align="center">
                                    ...
                                    <p style="margin-top:0px; margin-bottom:0px;font-size:11px;">Exchange</p>
                                </div>
                                ...
                                <div style="margin-top:5px; margin-bottom:0px;">
                                    <div class="row">
                                        ...
                                        <div class="col-6" align="left">
                                            <p style="margin-top:0px; margin-bottom:0px; margin-left:20px;"> New Net Amount
                                            </p>
                                        </div>
                                        <div class="col-6" align="right">
                                            <p style="margin-top:0px; margin-bottom:0px; margin-right:20px;">
                                                <?php $newAmount=floatval($oldAmount) + floatval($amount) ?>
                                                <?php echo number_format($newAmount,2) ?> </p>
                                        </div>
                                        <div class="col-6" align="left">
                                            <p style="margin-top:0px; margin-bottom:0px;margin-left:20px;"> Exchange Bill Payment
                                            </p>
                                        </div>
                                        <div class="col-6" align="right">
                                            <p
                                                    style="margin-top:0px; margin-bottom:0px; margin-right:0px; margin-right:20px;">
                                                <?php echo number_format($netAmount1,2) ?></p>
                                        </div>
