...
<body>
    ...
    <div class="wrapper sidebar_minimize">
            ...
            <div class="content">
                <div class="page-inner">
                    <div class="page-header">
                        <h4 class="page-title">DISPOSE PRODUCTS</h4>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div style="margin-top:3px">
                                                ...
                                                <input type="text" class="form-control" id="passText" placeholder="">
                                            </div>
                                            <br>
                                            <div style="margin-top:3px">
        ...
        function save() {
            ...
            obj = {
                "gatePass": document.getElementById("passText").value,
                proObj
            }

            $.ajax({
                url: "ajax/dispose-product-save.php",
                type: "POST",
                data: {
                    data: obj
                },
                        ...
                        var SweetAlert2Demo = function() {
                            var initDemos = function() {
                                swal({
                                    ...
                                    if (Delete) {
                                        window.location.href = "dispose-bill.php?id=" + res.pass;
                                    } else {
                                        window.location.href = "dispose-bill.php?id=" + res.pass;
                                    }
                                });
                ...
                if (tableData[i] !== undefined) {
                    ...
                    var tr_str = "<tr style='border-bottom:1pt; solid #D9EDF7;'>" +
                        ...
                        "(" + tableData[i].code + ")" + "</button></td>" + "<td style='text-align:center'>" + tableData[
                            i].price + ".00</td>" +
                        "<td><div><input type='number' class='form-control form-control-sm' id='" + tableData[i].id +
                        "' value='" + tableData[i].totQty + "' style='text-align:center' onkeyup='editQty(" + tableData[i].id + ")'></div></td>" + "<td style='text-align:center'>" +
