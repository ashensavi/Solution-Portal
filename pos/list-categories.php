...
<head>
    ...
    <title>List Categories | SKYPOS</title>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <a class=" ml-auto" href="add-categories.php">
                                    ...
                                    <div class="table-responsive">
                                        <table id="add-row" class="display table table-striped table-hover">
                                            ...
                                            <tbody>
												...
												echo "<tr>";
													echo "<td >".$dataRow['cate_code']."</td>";    
													echo "<td >".$dataRow['cat_name']."</td>";
													echo "<td>
														<div class=\"form-button-action\">
															<a href='edit-categories.php?id=$dataRow[cate_id]'>
															...
															<a onClick=\"javascript: return confirm('Please confirm deletion');\" href='delete-categorypro.php?id=$dataRow[cate_id]'>
