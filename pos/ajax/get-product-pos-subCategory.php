...
<?php
	...
	$sql = mysqli_query($connection,"SELECT * FROM products_tbl,stock_tbl,batch_tbl WHERE products_tbl.cat_id = '$cateid' AND products_tbl.subcat_id = '$subcateid' AND stock_tbl.pro_id = products_tbl.pro_id AND batch_tbl.batch_id = stock_tbl.batch_id AND batch_tbl.batch_location = '$location'");
	...
	while ($row = mysqli_fetch_array($sql)){
        ...
        echo "<div class='col-3 btn' title='".$row['pro_name']."' style='padding:2px;' onclick='addToTable(".$stockid.")'>
