                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="example" class="display table table-striped table-hover">
											...
											$sql="SELECT * FROM disposal_tbl,stock_tbl,products_tbl,location_tbl,batch_tbl WHERE stock_tbl.stock_id = disposal_tbl.dispos_stock_id AND products_tbl.pro_id = stock_tbl.pro_id AND location_tbl.loc_id = stock_tbl.stock_location AND batch_tbl.batch_id = stock_tbl.batch_id AND batch_tbl.batch_location = '$location'";
