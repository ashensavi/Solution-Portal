        ...
        <div class="main-panel">
            <div class="content">
                <?php
                    ...
                    $sql = "INSERT INTO products_tbl(`pro_id`,`pro_name`,`pro_code`,`cat_id`,`subcat_id`,`brand_id`,`pro_desc`,`pro_cost`,`pro_price`,`pro_all_qty`,`pro_img`,`supplier_id`,`added_date`,`added_user`)VALUES(
                            '',
                            '$name',
                            '$code',
                            '$category',
