<!-- <div class="custom-template">
			...
			<script>
				...
				// }
				document.getElementById("navbarheader").removeAttribute("data-background-color");
				document.getElementById("navbarheader").setAttribute("data-background-color", "red2");

				document.getElementById("logoheader").removeAttribute("data-background-color");
				document.getElementById("logoheader").setAttribute("data-background-color", "red2");

				// document.getElementsByTagName("body")[0].setAttribute("data-background-color", "dark");

				document.getElementById("sidebar").setAttribute("data-background-color", "red2");
			</script>
			<!-- <script>
