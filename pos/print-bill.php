                ...
                <div class="card">
                                ...
                                <div style="margin-top:5px; margin-bottom:0px;">
                                    <div class="row">
                                        ...
                                        <div class="col-6" align="right">
                                            <p
                                                style="margin-top:0px; margin-bottom:0px; margin-right:0px; margin-right:20px;">
                                                <?php echo $discount ?>% (<?php echo number_format($disPrice,2) ?>)
                                            </p>
                                        ...
                                        <?php } else { ?>
                                        <div class="col-6" align="left">
                                            <p style="margin-top:0px; margin-bottom:0px; margin-left:20px;"> Other Payment</p>
                                        </div>
                                        <?php } ?>
                                        <div class="col-6" align="right">
                                            <p style="margin-top:0px; margin-bottom:0px; margin-right:20px;">
                    ...
                    <div class="card-action">
                        <div onclick="print()" class="row" style="margin:0px;">
                            ...
                            <div onclick="nextBill1()" class="row" style="margin:0px;">
                            <div class="col-12 btn btn-warning" style="margin-top:5px; font-weight:bold;">
                                <span class="btn-label">
...
window.location.replace("print-full-bill.php?id=<?php echo $id?>")
}
    </script>
</body>
