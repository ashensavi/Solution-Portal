...
<!--                                    </p>-->
<!--                                    <p align="left" style="margin-top:0px; margin-bottom:0px;">Date : --><?php //echo $date ?>
<!--                                        --><?php //echo $time ?>
<!--                                    </p>-->
<!--                                    <p align="left" style="margin-top:0px; margin-bottom:0px;font-size:11px;">-->
<!--                                        Invoice :--><?php //echo $refNo ?><!-- </p>-->
<!--                                </div>-->
<!---->
...
<hr style="border-top: dotted 1px; margin-bottom:0px; margin-top:5px;" />
                                ...
                                <div style="margin-top:5px; margin-bottom:0px;">
                                    <div class="row">
                                        ...
                                        <div class="col-6" align="right">
                                            <p
                                                style="margin-top:0px; margin-bottom:0px; margin-right:0px; margin-right:20px;">
                                                <?php echo number_format($discount,2) ?>% (<?php echo number_format($disPrice,2) ?>)</p>
                                        </div>
                                ...
                                <div style="margin-top:5px; margin-bottom:0px;">
                                    <div class="row">
                                        <div class="col-6" align="left">
                                            <p style="margin-top:0px; margin-bottom:0px; margin-left:20px;"> Number Of Items </p>
                                        </div>
                                        <div class="col-6" align="right">
                                            <p style="margin-top:0px; margin-bottom:0px; margin-right:20px;">
                                                <?php echo $x-1 ?> </p>
                                ...
                                <div style="margin-top:5px; margin-bottom:0px;">
                                    <div class="row">
                                        ...
                                        <div class="col-6" align="right">
                                            <p style="margin-top:0px; margin-bottom:0px; margin-right:20px;">
                                                <?php echo $amount - $netAmount ?>.00 </p>
                                        </div>
                                    </div>
                                </div>
                                <hr style="border-top: dotted 1px; margin-bottom:0px; margin-top:5px;" />
                    ...
                    <div class="card-action">
                        <div class="row" style="margin:0px;">
                            ...
                            <div onclick="print()" class="col-12 btn btn-primary" style="margin-top:0px; font-weight:bold;">
                            ...
                            <div onclick="backToPOS()" class="col-12 btn btn-danger"
                            ...
                            <div onclick="backBill()" class="col-12 btn btn-warning" style="margin-top:5px; font-weight:bold;">
                                <span class="btn-label">
                                    <i class="fas fa-arrow-alt-circle-left"></i>
                                </span>
                                Normal Bill
