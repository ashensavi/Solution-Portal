                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group form-inline">
                                                <label for="inlineinput" class="col-md-4 col-form-label">GRN
                                                    Number</label>
                                            ...
                                            <div class="form-group form-inline">
                                                <label for="inlineinput" class="col-md-4 col-form-label">Stock Location</label>
                                                <div class="col-md-8 p-0">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group form-inline">
                                                <label for="inlineinput" class="col-md-4 col-form-label">Company Inv. No</label>
                                                <div class="col-md-8 p-0">
                                            ...
                                            <div class="form-group form-inline has-error has-feedback">
                                                <label for="inlineinput" class="col-md-4 col-form-label">Invoice
                                                    Value</label>
                                                <div class="col-md-8 p-0">
