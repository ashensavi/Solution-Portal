                                        ...
                                        <table id="add-row" class="display table table-striped table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                while($dataRow=mysqli_fetch_assoc($result)){
                                                    if ($_SESSION['user_id'] == $dataRow['user_id']){
                                                echo "<tr>";
                                                    ...
                                                    echo "<td>
                                                        <div class=\"form-button-action\">
                                                            ...
                                                            if ($_SESSION['user_type'] == 'super admin') {
                                                                echo "<a href='edit-user-role.php?id=$dataRow[user_id]'>
                                                                        <button type=\"button\" data-toggle=\"tooltip\" 		title=\"Edit User Authentications\" class=\"btn btn-link btn-primary btn-lg\" data-original-title=\"Edit Task\">
                                                            ...
                                                            echo "    <a onClick=\"javascript: return confirm('Please confirm deletion');\" href='delete-user.php?id=$dataRow[user_id]'>
