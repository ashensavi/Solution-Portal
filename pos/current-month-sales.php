...
<head>
    ...
    <title>Sales Report-Current month | SKYPOS</title>
                                    ...
                                    <div class="table-responsive">
                                        <table id="example" class="display table table-striped table-hover">
                                            ...
                                            <tbody id="tbody">
                                                ...
                                                $sqlT = "SELECT * FROM pos_tbl,user_tbl WHERE MONTH(checkRegDate) = MONTH(CURRENT_DATE()) AND YEAR(checkRegDate) = YEAR(CURRENT_DATE()) AND user_tbl.user_id = pos_tbl.added_user AND user_tbl.user_loc ='$userLocationId' ";
                                                // $sqlT = "SELECT * FROM pos_tbl,user_tbl WHERE user_tbl.user_id = pos_tbl.added_user AND user_tbl.user_loc ='$userLocationId'";
 ...
 $data=explode("/",$dataRow['proDesc']);
    ...
    <script>
        ...
        function pageReload() {
            ...
            xmlhttp.open("GET", "ajax/get-get-monthly-sales.php?locationId=" + locationId, true);
            xmlhttp.send();
        }
    </script>
