                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="example" class="display table table-striped table-hover">
                                ...
                                <tbody id="tbody">
                                    <?php
                                    $sql="SELECT * FROM pos_details_tbl,stock_tbl,batch_tbl,products_tbl WHERE pos_details_tbl.pos_id = $posId AND stock_tbl.stock_id = pos_details_tbl.stock_id And batch_tbl.batch_id = stock_tbl.batch_id AND products_tbl.pro_id = stock_tbl.pro_id";
