...
<body id="kkkk" onload="myFunction()">
	<div class="wrapper">
		...
		<div class="main-panel">
			<div class="content">
				<div class="panel-header bg-primary-gradient" style="background : linear-gradient(87deg, rgb(3,3,83) 0px, rgb(239,101,129) 100%) !important;">
				...
				// 			$sql7="SELECT * FROM `pos_tbl` WHERE pos_date = '$date'";
							$sql7="SELECT * FROM pos_tbl,user_tbl WHERE pos_date = '$date' AND pos_tbl.bill_void = 0 AND user_tbl.user_id = pos_tbl.added_user AND user_tbl.user_loc = $_SESSION[user_loc]";
				...
				// 			$sql4="SELECT * FROM `pos_tbl` WHERE pos_date = '$date' AND pos_tbl.bill_void = 0";
							$sql4="SELECT * FROM pos_tbl,user_tbl WHERE pos_date = '$date' AND pos_tbl.bill_void = 0 AND user_tbl.user_id = pos_tbl.added_user AND user_tbl.user_loc = $_SESSION[user_loc]";
						...
						<?php 
							...
							$sql6="SELECT * FROM user_tbl where user_tbl.user_loc = $_SESSION[user_loc]";
...
// 	$sql="SELECT * FROM customer_tbl WHERE added_date = '$date'";
	$sql="SELECT * FROM customer_tbl,user_tbl WHERE customer_tbl.added_date = '$date' AND user_tbl.user_id = customer_tbl.added_user AND user_tbl.user_loc = $_SESSION[user_loc]";
...
// 	$sql1="SELECT * FROM `pos_tbl` WHERE pos_date = '$date'";
	$sql1="SELECT * FROM pos_tbl,user_tbl WHERE pos_date = '$date' AND pos_tbl.bill_void = 0 AND user_tbl.user_id = pos_tbl.added_user AND user_tbl.user_loc = $_SESSION[user_loc]";
    ...
    $sql2="SELECT * FROM stock_tbl,products_tbl,location_tbl,batch_tbl WHERE products_tbl.pro_id = stock_tbl.pro_id AND location_tbl.loc_id = stock_tbl.stock_location AND batch_tbl.batch_id = stock_tbl.batch_id AND batch_tbl.batch_location = $_SESSION[user_loc]";
